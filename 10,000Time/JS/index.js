...
function calculator() {
    ...
    let timeValue = document.querySelector("#study_time");
    let timeValue_int = Number(timeValue.value);

    const fieldResult = document.querySelector("#become_programming_result");
    const timeResult = document.querySelector("#tranning_time_result");
